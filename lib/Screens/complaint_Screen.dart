  ...
  Future<void> insertRecord() async {
    if (animal_type.text.isNotEmpty && street_no.text.isNotEmpty && region.text.isNotEmpty && description.text.isNotEmpty) {
      try {
        ...
        complaint_model complaint = complaint_model(
          typeOfAnimal: animal_type.text,
          region: region.text,
          streetNumber: street_no.text,
          description: description.text,
        );
        String url = "http://localhost/connectiondb/insert_complaint.php";  // Use your local IP address here
        var res = await http.post(Uri.parse(url), body: complaint.toJson());
